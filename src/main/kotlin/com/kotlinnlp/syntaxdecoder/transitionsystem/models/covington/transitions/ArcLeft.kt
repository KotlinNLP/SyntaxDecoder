 ...
 * @property dependentStack1Index the position in the stack 1 of the governor element
...
class ArcLeft(
   ...
   * The dependent id.
   */
  override val dependentId: Int get() = this.refState.stack1[this.refState.stack1.size - this.dependentStack1Index]

  /**
   * Returns True if the action is allowed in the given parser state.
   */
  override val isAllowed: Boolean get() = this.refState.buffer.isNotEmpty()
    && this.refState.stack1.size >= this.dependentStack1Index
  ...
  override fun perform(state: CovingtonState) {
    ...
    val fromIndex = this.refState.stack1.size - this.dependentStack1Index
   ...
   */
  override fun toString(): String = "arc-left(${this.dependentStack1Index})"
}
